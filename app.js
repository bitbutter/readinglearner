...
const WORDS_CONTENT = [
  ...
  { id: 'word:bad',   display: 'bad',    accepted: ['bad'],             level: 1 },
  { id: 'word:dad',   display: 'dad',    accepted: ['dad'],             level: 1 },
  { id: 'word:mad',   display: 'mad',    accepted: ['mad'],             level: 1 },
  { id: 'word:sad',   display: 'sad',    accepted: ['sad'],             level: 1 },
  { id: 'word:bag',   display: 'bag',    accepted: ['bag'],             level: 1 },
  { id: 'word:tag',   display: 'tag',    accepted: ['tag'],             level: 1 },
  { id: 'word:rag',   display: 'rag',    accepted: ['rag'],             level: 1 },
  { id: 'word:can',   display: 'can',    accepted: ['can'],             level: 1 },
  { id: 'word:man',   display: 'man',    accepted: ['man'],             level: 1 },
  { id: 'word:pan',   display: 'pan',    accepted: ['pan'],             level: 1 },
  { id: 'word:ran',   display: 'ran',    accepted: ['ran'],             level: 1 },
  { id: 'word:cap',   display: 'cap',    accepted: ['cap'],             level: 1 },
  { id: 'word:map',   display: 'map',    accepted: ['map'],             level: 1 },
  { id: 'word:tap',   display: 'tap',    accepted: ['tap'],             level: 1 },
  // Level 2: Simple sounds (short e, i, o, u)
  { id: 'word:bed',   display: 'bed',    accepted: ['bed'],             level: 2 },
  { id: 'word:hen',   display: 'hen',    accepted: ['hen'],             level: 2 },
  { id: 'word:pen',   display: 'pen',    accepted: ['pen'],             level: 2 },
  { id: 'word:net',   display: 'net',    accepted: ['net'],             level: 2 },
  { id: 'word:wet',   display: 'wet',    accepted: ['wet'],             level: 2 },
  { id: 'word:pig',   display: 'pig',    accepted: ['pig'],             level: 2 },
  { id: 'word:pin',   display: 'pin',    accepted: ['pin'],             level: 2 },
  { id: 'word:lip',   display: 'lip',    accepted: ['lip'],             level: 2 },
  { id: 'word:fin',   display: 'fin',    accepted: ['fin'],             level: 2 },
  { id: 'word:zip',   display: 'zip',    accepted: ['zip'],             level: 2 },
  { id: 'word:pot',   display: 'pot',    accepted: ['pot'],             level: 2 },
  { id: 'word:log',   display: 'log',    accepted: ['log'],             level: 2 },
  { id: 'word:fox',   display: 'fox',    accepted: ['fox'],             level: 2 },
  { id: 'word:hop',   display: 'hop',    accepted: ['hop'],             level: 2 },
  { id: 'word:mop',   display: 'mop',    accepted: ['mop'],             level: 2 },
  { id: 'word:bus',   display: 'bus',    accepted: ['bus'],             level: 2 },
  { id: 'word:bug',   display: 'bug',    accepted: ['bug'],             level: 2 },
  ...
  { id: 'word:at',      display: 'at',      accepted: ['at'],                    level: 4 },
  { id: 'word:ate',     display: 'ate',     accepted: ['ate'],                   level: 4 },
  { id: 'word:be',      display: 'be',      accepted: ['be','bee'],              level: 4 },
  { id: 'word:black',   display: 'black',   accepted: ['black'],                 level: 4 },
  { id: 'word:brown',   display: 'brown',   accepted: ['brown'],                 level: 4 },
  { id: 'word:but',     display: 'but',     accepted: ['but'],                   level: 4 },
  { id: 'word:came',    display: 'came',    accepted: ['came'],                  level: 4 },
  { id: 'word:did',     display: 'did',     accepted: ['did'],                   level: 4 },
  { id: 'word:do',      display: 'do',      accepted: ['do','dew','due'],        level: 4 },
  { id: 'word:get',     display: 'get',     accepted: ['get'],                   level: 4 },
  { id: 'word:good',    display: 'good',    accepted: ['good'],                  level: 4 },
  { id: 'word:have',    display: 'have',    accepted: ['have'],                  level: 4 },
  { id: 'word:he',      display: 'he',      accepted: ['he'],                    level: 4 },
  { id: 'word:into',    display: 'into',    accepted: ['into'],                  level: 4 },
  { id: 'word:like',    display: 'like',    accepted: ['like'],                  level: 4 },
  { id: 'word:must',    display: 'must',    accepted: ['must'],                  level: 4 },
  { id: 'word:new',     display: 'new',     accepted: ['new','knew'],            level: 4 },
  { id: 'word:no',      display: 'no',      accepted: ['no','know'],             level: 4 },
  { id: 'word:now',     display: 'now',     accepted: ['now'],                   level: 4 },
  { id: 'word:on',      display: 'on',      accepted: ['on'],                    level: 4 },
  { id: 'word:our',     display: 'our',     accepted: ['our','hour'],            level: 4 },
  { id: 'word:out',     display: 'out',     accepted: ['out'],                   level: 4 },
  { id: 'word:please',  display: 'please',  accepted: ['please'],                level: 4 },
  { id: 'word:pretty',  display: 'pretty',  accepted: ['pretty'],                level: 4 },
  { id: 'word:ride',    display: 'ride',    accepted: ['ride'],                  level: 4 },
  { id: 'word:saw',     display: 'saw',     accepted: ['saw'],                   level: 4 },
  { id: 'word:say',     display: 'say',     accepted: ['say'],                   level: 4 },
  { id: 'word:she',     display: 'she',     accepted: ['she'],                   level: 4 },
  { id: 'word:so',      display: 'so',      accepted: ['so','sew'],              level: 4 },
  { id: 'word:soon',    display: 'soon',    accepted: ['soon'],                  level: 4 },
  { id: 'word:that',    display: 'that',    accepted: ['that'],                  level: 4 },
  { id: 'word:they',    display: 'they',    accepted: ['they'],                  level: 4 },
  { id: 'word:this',    display: 'this',    accepted: ['this'],                  level: 4 },
  { id: 'word:too',     display: 'too',     accepted: ['too','to','two'],        level: 4 },
  { id: 'word:under',   display: 'under',   accepted: ['under'],                 level: 4 },
  { id: 'word:want',    display: 'want',    accepted: ['want'],                  level: 4 },
  { id: 'word:was',     display: 'was',     accepted: ['was'],                   level: 4 },
  { id: 'word:well',    display: 'well',    accepted: ['well'],                  level: 4 },
  { id: 'word:went',    display: 'went',    accepted: ['went'],                  level: 4 },
  { id: 'word:what',    display: 'what',    accepted: ['what'],                  level: 4 },
  { id: 'word:white',   display: 'white',   accepted: ['white'],                 level: 4 },
  { id: 'word:who',     display: 'who',     accepted: ['who'],                   level: 4 },
  { id: 'word:will',    display: 'will',    accepted: ['will'],                  level: 4 },
  { id: 'word:yes',     display: 'yes',     accepted: ['yes'],                   level: 4 },
  // Level 5: Dolch Grade 1
  { id: 'word:after',   display: 'after',   accepted: ['after'],                 level: 5 },
  { id: 'word:again',   display: 'again',   accepted: ['again'],                 level: 5 },
  { id: 'word:an',      display: 'an',      accepted: ['an'],                    level: 5 },
  { id: 'word:any',     display: 'any',     accepted: ['any'],                   level: 5 },
  { id: 'word:as',      display: 'as',      accepted: ['as'],                    level: 5 },
  { id: 'word:ask',     display: 'ask',     accepted: ['ask'],                   level: 5 },
  { id: 'word:by',      display: 'by',      accepted: ['by','bye','buy'],        level: 5 },
  { id: 'word:could',   display: 'could',   accepted: ['could'],                 level: 5 },
  { id: 'word:every',   display: 'every',   accepted: ['every'],                 level: 5 },
  { id: 'word:fly',     display: 'fly',     accepted: ['fly'],                   level: 5 },
  { id: 'word:from',    display: 'from',    accepted: ['from'],                  level: 5 },
  { id: 'word:give',    display: 'give',    accepted: ['give'],                  level: 5 },
  { id: 'word:going',   display: 'going',   accepted: ['going'],                 level: 5 },
  { id: 'word:had',     display: 'had',     accepted: ['had'],                   level: 5 },
  { id: 'word:has',     display: 'has',     accepted: ['has'],                   level: 5 },
  { id: 'word:her',     display: 'her',     accepted: ['her'],                   level: 5 },
  { id: 'word:him',     display: 'him',     accepted: ['him'],                   level: 5 },
  { id: 'word:his',     display: 'his',     accepted: ['his'],                   level: 5 },
  { id: 'word:how',     display: 'how',     accepted: ['how'],                   level: 5 },
  { id: 'word:just',    display: 'just',    accepted: ['just'],                  level: 5 },
  { id: 'word:know',    display: 'know',    accepted: ['know','no'],             level: 5 },
  { id: 'word:let',     display: 'let',     accepted: ['let'],                   level: 5 },
  { id: 'word:live',    display: 'live',    accepted: ['live'],                  level: 5 },
  { id: 'word:may',     display: 'may',     accepted: ['may'],                   level: 5 },
  { id: 'word:of',      display: 'of',      accepted: ['of'],                    level: 5 },
  { id: 'word:old',     display: 'old',     accepted: ['old'],                   level: 5 },
  { id: 'word:once',    display: 'once',    accepted: ['once'],                  level: 5 },
  { id: 'word:open',    display: 'open',    accepted: ['open'],                  level: 5 },
  { id: 'word:over',    display: 'over',    accepted: ['over'],                  level: 5 },
  { id: 'word:put',     display: 'put',     accepted: ['put'],                   level: 5 },
  { id: 'word:round',   display: 'round',   accepted: ['round'],                 level: 5 },
  { id: 'word:some',    display: 'some',    accepted: ['some','sum'],            level: 5 },
  { id: 'word:stop',    display: 'stop',    accepted: ['stop'],                  level: 5 },
  { id: 'word:take',    display: 'take',    accepted: ['take'],                  level: 5 },
  { id: 'word:thank',   display: 'thank',   accepted: ['thank'],                 level: 5 },
  { id: 'word:them',    display: 'them',    accepted: ['them'],                  level: 5 },
  { id: 'word:think',   display: 'think',   accepted: ['think'],                 level: 5 },
  { id: 'word:walk',    display: 'walk',    accepted: ['walk'],                  level: 5 },
  { id: 'word:were',    display: 'were',    accepted: ['were','where','wear'],   level: 5 },
  { id: 'word:when',    display: 'when',    accepted: ['when'],                  level: 5 },
  // Level 6: Dolch Grade 2
  { id: 'word:always',  display: 'always',  accepted: ['always'],                level: 6 },
  { id: 'word:around',  display: 'around',  accepted: ['around'],                level: 6 },
  { id: 'word:because', display: 'because', accepted: ['because'],               level: 6 },
  { id: 'word:been',    display: 'been',    accepted: ['been','bin'],            level: 6 },
  { id: 'word:before',  display: 'before',  accepted: ['before'],                level: 6 },
  { id: 'word:best',    display: 'best',    accepted: ['best'],                  level: 6 },
  { id: 'word:both',    display: 'both',    accepted: ['both'],                  level: 6 },
  { id: 'word:buy',     display: 'buy',     accepted: ['buy','by','bye'],        level: 6 },
  { id: 'word:call',    display: 'call',    accepted: ['call'],                  level: 6 },
  { id: 'word:cold',    display: 'cold',    accepted: ['cold'],                  level: 6 },
  { id: 'word:does',    display: 'does',    accepted: ['does','duz'],            level: 6 },
  { id: 'word:dont',    display: "don't",   accepted: ["don't",'dont'],          level: 6 },
  { id: 'word:fast',    display: 'fast',    accepted: ['fast'],                  level: 6 },
  { id: 'word:first',   display: 'first',   accepted: ['first'],                 level: 6 },
  { id: 'word:five',    display: 'five',    accepted: ['five'],                  level: 6 },
  { id: 'word:found',   display: 'found',   accepted: ['found'],                 level: 6 },
  { id: 'word:gave',    display: 'gave',    accepted: ['gave'],                  level: 6 },
  { id: 'word:goes',    display: 'goes',    accepted: ['goes'],                  level: 6 },
  { id: 'word:green',   display: 'green',   accepted: ['green'],                 level: 6 },
  { id: 'word:its',     display: 'its',     accepted: ['its'],                   level: 6 },
  { id: 'word:made',    display: 'made',    accepted: ['made','maid'],           level: 6 },
  { id: 'word:many',    display: 'many',    accepted: ['many'],                  level: 6 },
  { id: 'word:off',     display: 'off',     accepted: ['off'],                   level: 6 },
  { id: 'word:or',      display: 'or',      accepted: ['or','ore','oar'],        level: 6 },
  { id: 'word:pull',    display: 'pull',    accepted: ['pull'],                  level: 6 },
  { id: 'word:read',    display: 'read',    accepted: ['read','red'],            level: 6 },
  { id: 'word:right',   display: 'right',   accepted: ['right','write'],         level: 6 },
  { id: 'word:sing',    display: 'sing',    accepted: ['sing'],                  level: 6 },
  { id: 'word:sit',     display: 'sit',     accepted: ['sit'],                   level: 6 },
  { id: 'word:sleep',   display: 'sleep',   accepted: ['sleep'],                 level: 6 },
  { id: 'word:tell',    display: 'tell',    accepted: ['tell'],                  level: 6 },
  { id: 'word:their',   display: 'their',   accepted: ['their','there'],         level: 6 },
  { id: 'word:these',   display: 'these',   accepted: ['these'],                 level: 6 },
  { id: 'word:those',   display: 'those',   accepted: ['those'],                 level: 6 },
  { id: 'word:upon',    display: 'upon',    accepted: ['upon'],                  level: 6 },
  { id: 'word:us',      display: 'us',      accepted: ['us'],                    level: 6 },
  { id: 'word:use',     display: 'use',     accepted: ['use','yooz'],            level: 6 },
  { id: 'word:very',    display: 'very',    accepted: ['very'],                  level: 6 },
  { id: 'word:wash',    display: 'wash',    accepted: ['wash'],                  level: 6 },
  { id: 'word:which',   display: 'which',   accepted: ['which','witch'],         level: 6 },
  { id: 'word:why',     display: 'why',     accepted: ['why'],                   level: 6 },
  { id: 'word:wish',    display: 'wish',    accepted: ['wish'],                  level: 6 },
  { id: 'word:work',    display: 'work',    accepted: ['work'],                  level: 6 },
  { id: 'word:would',   display: 'would',   accepted: ['would','wood'],          level: 6 },
  { id: 'word:write',   display: 'write',   accepted: ['write','right'],         level: 6 },
  { id: 'word:your',    display: 'your',    accepted: ['your','you\'re'],        level: 6 },
  // Level 7: Dolch Grade 3
  { id: 'word:about',    display: 'about',    accepted: ['about'],               level: 7 },
  { id: 'word:better',   display: 'better',   accepted: ['better'],              level: 7 },
  { id: 'word:bring',    display: 'bring',    accepted: ['bring'],               level: 7 },
  { id: 'word:carry',    display: 'carry',    accepted: ['carry'],               level: 7 },
  { id: 'word:clean',    display: 'clean',    accepted: ['clean'],               level: 7 },
  { id: 'word:cut',      display: 'cut',      accepted: ['cut'],                 level: 7 },
  { id: 'word:done',     display: 'done',     accepted: ['done','dun'],          level: 7 },
  { id: 'word:draw',     display: 'draw',     accepted: ['draw'],                level: 7 },
  { id: 'word:drink',    display: 'drink',    accepted: ['drink'],               level: 7 },
  { id: 'word:eight',    display: 'eight',    accepted: ['eight','ate'],         level: 7 },
  { id: 'word:fall',     display: 'fall',     accepted: ['fall'],                level: 7 },
  { id: 'word:far',      display: 'far',      accepted: ['far'],                 level: 7 },
  { id: 'word:full',     display: 'full',     accepted: ['full'],                level: 7 },
  { id: 'word:got',      display: 'got',      accepted: ['got'],                 level: 7 },
  { id: 'word:grow',     display: 'grow',     accepted: ['grow'],                level: 7 },
  { id: 'word:hold',     display: 'hold',     accepted: ['hold'],                level: 7 },
  { id: 'word:hot',      display: 'hot',      accepted: ['hot'],                 level: 7 },
  { id: 'word:hurt',     display: 'hurt',     accepted: ['hurt'],                level: 7 },
  { id: 'word:if',       display: 'if',       accepted: ['if'],                  level: 7 },
  { id: 'word:keep',     display: 'keep',     accepted: ['keep'],                level: 7 },
  { id: 'word:kind',     display: 'kind',     accepted: ['kind'],                level: 7 },
  { id: 'word:laugh',    display: 'laugh',    accepted: ['laugh','laf'],         level: 7 },
  { id: 'word:light',    display: 'light',    accepted: ['light'],               level: 7 },
  { id: 'word:long',     display: 'long',     accepted: ['long'],                level: 7 },
  { id: 'word:much',     display: 'much',     accepted: ['much'],                level: 7 },
  { id: 'word:myself',   display: 'myself',   accepted: ['myself'],              level: 7 },
  { id: 'word:never',    display: 'never',    accepted: ['never'],               level: 7 },
  { id: 'word:only',     display: 'only',     accepted: ['only'],                level: 7 },
  { id: 'word:own',      display: 'own',      accepted: ['own'],                 level: 7 },
  { id: 'word:pick',     display: 'pick',     accepted: ['pick'],                level: 7 },
  { id: 'word:seven',    display: 'seven',    accepted: ['seven'],               level: 7 },
  { id: 'word:shall',    display: 'shall',    accepted: ['shall'],               level: 7 },
  { id: 'word:show',     display: 'show',     accepted: ['show'],                level: 7 },
  { id: 'word:six',      display: 'six',      accepted: ['six'],                 level: 7 },
  { id: 'word:small',    display: 'small',    accepted: ['small'],               level: 7 },
  { id: 'word:start',    display: 'start',    accepted: ['start'],               level: 7 },
  { id: 'word:ten',      display: 'ten',      accepted: ['ten'],                 level: 7 },
  { id: 'word:today',    display: 'today',    accepted: ['today'],               level: 7 },
  { id: 'word:together', display: 'together', accepted: ['together'],            level: 7 },
  { id: 'word:try',      display: 'try',      accepted: ['try'],                 level: 7 },
  { id: 'word:warm',     display: 'warm',     accepted: ['warm'],                level: 7 },
  // Level 8: High-frequency words
  { id: 'word:time',     display: 'time',     accepted: ['time'],                level: 8 },
  { id: 'word:water',    display: 'water',    accepted: ['water'],               level: 8 },
  { id: 'word:people',   display: 'people',   accepted: ['people'],              level: 8 },
  { id: 'word:year',     display: 'year',     accepted: ['year'],                level: 8 },
  { id: 'word:back',     display: 'back',     accepted: ['back'],                level: 8 },
  { id: 'word:home',     display: 'home',     accepted: ['home'],                level: 8 },
  { id: 'word:place',    display: 'place',    accepted: ['place'],               level: 8 },
  { id: 'word:end',      display: 'end',      accepted: ['end'],                 level: 8 },
  { id: 'word:land',     display: 'land',     accepted: ['land'],                level: 8 },
  { id: 'word:air',      display: 'air',      accepted: ['air','ere'],           level: 8 },
  { id: 'word:animal',   display: 'animal',   accepted: ['animal'],              level: 8 },
  { id: 'word:mother',   display: 'mother',   accepted: ['mother'],              level: 8 },
  { id: 'word:face',     display: 'face',     accepted: ['face'],                level: 8 },
  { id: 'word:family',   display: 'family',   accepted: ['family'],              level: 8 },
  { id: 'word:school',   display: 'school',   accepted: ['school'],              level: 8 },
  { id: 'word:father',   display: 'father',   accepted: ['father'],              level: 8 },
  { id: 'word:body',     display: 'body',     accepted: ['body'],                level: 8 },
  { id: 'word:food',     display: 'food',     accepted: ['food'],                level: 8 },
  { id: 'word:more',     display: 'more',     accepted: ['more'],                level: 8 },
  { id: 'word:door',     display: 'door',     accepted: ['door'],                level: 8 },
  // Level 9: Nature and everyday life
  { id: 'word:music',    display: 'music',    accepted: ['music'],               level: 9 },
  { id: 'word:colour',   display: 'colour',   accepted: ['colour','color'],      level: 9 },
  { id: 'word:sun',      display: 'sun',      accepted: ['sun','son'],           level: 9 },
  { id: 'word:fish',     display: 'fish',     accepted: ['fish'],                level: 9 },
  { id: 'word:dog',      display: 'dog',      accepted: ['dog'],                 level: 9 },
  { id: 'word:horse',    display: 'horse',    accepted: ['horse'],               level: 9 },
  { id: 'word:river',    display: 'river',    accepted: ['river'],               level: 9 },
  { id: 'word:sea',      display: 'sea',      accepted: ['sea','see'],           level: 9 },
  { id: 'word:bird',     display: 'bird',     accepted: ['bird'],                level: 9 },
  { id: 'word:tree',     display: 'tree',     accepted: ['tree'],                level: 9 },
  { id: 'word:mountain', display: 'mountain', accepted: ['mountain'],            level: 9 },
  { id: 'word:morning',  display: 'morning',  accepted: ['morning'],             level: 9 },
  { id: 'word:night',    display: 'night',    accepted: ['night','nite'],        level: 9 },
  { id: 'word:city',     display: 'city',     accepted: ['city'],                level: 9 },
  { id: 'word:road',     display: 'road',     accepted: ['road','rode'],         level: 9 },
  { id: 'word:room',     display: 'room',     accepted: ['room'],                level: 9 },
  { id: 'word:book',     display: 'book',     accepted: ['book'],                level: 9 },
  { id: 'word:page',     display: 'page',     accepted: ['page'],                level: 9 },
  { id: 'word:story',    display: 'story',    accepted: ['story'],               level: 9 },
  { id: 'word:friend',   display: 'friend',   accepted: ['friend'],              level: 9 },
  // Level 10: Home and school
  { id: 'word:children', display: 'children', accepted: ['children'],            level: 10 },
  { id: 'word:brother',  display: 'brother',  accepted: ['brother'],             level: 10 },
  { id: 'word:sister',   display: 'sister',   accepted: ['sister'],              level: 10 },
  { id: 'word:teacher',  display: 'teacher',  accepted: ['teacher'],             level: 10 },
  { id: 'word:window',   display: 'window',   accepted: ['window'],              level: 10 },
  { id: 'word:table',    display: 'table',    accepted: ['table'],               level: 10 },
  { id: 'word:chair',    display: 'chair',    accepted: ['chair'],               level: 10 },
  { id: 'word:floor',    display: 'floor',    accepted: ['floor'],               level: 10 },
  { id: 'word:wall',     display: 'wall',     accepted: ['wall'],                level: 10 },
  { id: 'word:clock',    display: 'clock',    accepted: ['clock'],               level: 10 },
  { id: 'word:paper',    display: 'paper',    accepted: ['paper'],               level: 10 },
  { id: 'word:pencil',   display: 'pencil',   accepted: ['pencil'],              level: 10 },
  { id: 'word:picture',  display: 'picture',  accepted: ['picture'],             level: 10 },
  { id: 'word:street',   display: 'street',   accepted: ['street'],              level: 10 },
  { id: 'word:garden',   display: 'garden',   accepted: ['garden'],              level: 10 },
  { id: 'word:kitchen',  display: 'kitchen',  accepted: ['kitchen'],             level: 10 },
  { id: 'word:weather',  display: 'weather',  accepted: ['weather','whether'],   level: 10 },
  { id: 'word:sound',    display: 'sound',    accepted: ['sound'],               level: 10 },
  { id: 'word:earth',    display: 'earth',    accepted: ['earth'],               level: 10 },
  { id: 'word:idea',     display: 'idea',     accepted: ['idea'],                level: 10 },
];
...
function loadStored() {
  try {
    ...
    // One-time migration: a decodable CVC tier was inserted as Levels 1–2 and
    // the Dolch ladder shifted up (old Levels 9–10 dropped to keep the cap at
    // 10). Re-sync every canonical word item's level from the content list, and
    // send the child back to the new Level 1 so they start on the simple sounds.
    if (!parsed.cvcLevels) {
      const canonLevel = {};
      for (const c of WORDS_CONTENT) canonLevel[c.id] = c.level;
      for (const [id, item] of Object.entries(parsed.items)) {
        if (id in canonLevel) item.level = canonLevel[id];
      }
      parsed.settings.wordLevel = 1;
      parsed.cvcLevels = true;
    }

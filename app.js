...
const WORDS_CONTENT = [
  ...
  // Level 4: Magic e, long-vowel teams (ee, oo, ay, ai, oa), plus a small
  // function-word core. Only 'are' is not decodable.
  { id: 'word:cake',  display: 'cake',   accepted: ['cake'],                    level: 4 },
  { id: 'word:make',  display: 'make',   accepted: ['make'],                    level: 4 },
  { id: 'word:tape',  display: 'tape',   accepted: ['tape'],                    level: 4 },
  { id: 'word:gate',  display: 'gate',   accepted: ['gate'],                    level: 4 },
  { id: 'word:name',  display: 'name',   accepted: ['name'],                    level: 4 },
  { id: 'word:bike',  display: 'bike',   accepted: ['bike'],                    level: 4 },
  { id: 'word:pipe',  display: 'pipe',   accepted: ['pipe'],                    level: 4 },
  { id: 'word:ride',  display: 'ride',   accepted: ['ride'],                    level: 4 },
  { id: 'word:five',  display: 'five',   accepted: ['five'],                    level: 4 },
  { id: 'word:cube',  display: 'cube',   accepted: ['cube'],                    level: 4 },
  { id: 'word:cute',  display: 'cute',   accepted: ['cute'],                    level: 4 },
  { id: 'word:tube',  display: 'tube',   accepted: ['tube'],                    level: 4 },
  { id: 'word:home',  display: 'home',   accepted: ['home'],                    level: 4 },
  { id: 'word:bone',  display: 'bone',   accepted: ['bone'],                    level: 4 },
  { id: 'word:note',  display: 'note',   accepted: ['note'],                    level: 4 },
  { id: 'word:see',   display: 'see',    accepted: ['see','sea'],               level: 4 },
  { id: 'word:feed',  display: 'feed',   accepted: ['feed'],                    level: 4 },
  { id: 'word:meet',  display: 'meet',   accepted: ['meet'],                    level: 4 },
  { id: 'word:sweet', display: 'sweet',  accepted: ['sweet'],                   level: 4 },
  { id: 'word:moon',  display: 'moon',   accepted: ['moon'],                    level: 4 },
  { id: 'word:boot',  display: 'boot',   accepted: ['boot'],                    level: 4 },
  { id: 'word:cool',  display: 'cool',   accepted: ['cool'],                    level: 4 },
  { id: 'word:food',  display: 'food',   accepted: ['food'],                    level: 4 },
  { id: 'word:play',  display: 'play',   accepted: ['play'],                    level: 4 },
  { id: 'word:day',   display: 'day',    accepted: ['day'],                     level: 4 },
  { id: 'word:say',   display: 'say',    accepted: ['say'],                     level: 4 },
  { id: 'word:way',   display: 'way',    accepted: ['way'],                     level: 4 },
  { id: 'word:rain',  display: 'rain',   accepted: ['rain'],                    level: 4 },
  { id: 'word:train', display: 'train',  accepted: ['train'],                   level: 4 },
  { id: 'word:boat',  display: 'boat',   accepted: ['boat'],                    level: 4 },
  { id: 'word:coat',  display: 'coat',   accepted: ['coat'],                    level: 4 },
  ...
  { id: 'word:we',    display: 'we',     accepted: ['we','wee'],                level: 4 },

...
const WORDS_CONTENT = [
  ...
  // Level 5: r-controlled vowels, igh, ea, air and remaining teams, plus a
  // small function-word core. Only 'was' is not decodable.
  { id: 'word:car',    display: 'car',    accepted: ['car'],                     level: 5 },
  { id: 'word:star',   display: 'star',   accepted: ['star'],                    level: 5 },
  { id: 'word:arm',    display: 'arm',    accepted: ['arm'],                     level: 5 },
  { id: 'word:farm',   display: 'farm',   accepted: ['farm'],                    level: 5 },
  { id: 'word:park',   display: 'park',   accepted: ['park'],                    level: 5 },
  { id: 'word:part',   display: 'part',   accepted: ['part'],                    level: 5 },
  { id: 'word:cart',   display: 'cart',   accepted: ['cart'],                    level: 5 },
  { id: 'word:fork',   display: 'fork',   accepted: ['fork'],                    level: 5 },
  { id: 'word:corn',   display: 'corn',   accepted: ['corn'],                    level: 5 },
  { id: 'word:horn',   display: 'horn',   accepted: ['horn'],                    level: 5 },
  { id: 'word:short',  display: 'short',  accepted: ['short'],                   level: 5 },
  { id: 'word:shore',  display: 'shore',  accepted: ['shore'],                   level: 5 },
  { id: 'word:her',    display: 'her',    accepted: ['her'],                     level: 5 },
  { id: 'word:bird',   display: 'bird',   accepted: ['bird'],                    level: 5 },
  { id: 'word:girl',   display: 'girl',   accepted: ['girl'],                    level: 5 },
  { id: 'word:turn',   display: 'turn',   accepted: ['turn'],                    level: 5 },
  { id: 'word:hurt',   display: 'hurt',   accepted: ['hurt'],                    level: 5 },
  { id: 'word:burn',   display: 'burn',   accepted: ['burn'],                    level: 5 },
  { id: 'word:tiger',  display: 'tiger',  accepted: ['tiger'],                   level: 5 },
  { id: 'word:door',   display: 'door',   accepted: ['door'],                    level: 5 },
  { id: 'word:floor',  display: 'floor',  accepted: ['floor'],                   level: 5 },
  { id: 'word:store',  display: 'store',  accepted: ['store'],                   level: 5 },
  { id: 'word:more',   display: 'more',   accepted: ['more'],                    level: 5 },
  { id: 'word:coin',   display: 'coin',   accepted: ['coin'],                    level: 5 },
  { id: 'word:join',   display: 'join',   accepted: ['join'],                    level: 5 },
  { id: 'word:toy',    display: 'toy',    accepted: ['toy'],                     level: 5 },
  { id: 'word:boy',    display: 'boy',    accepted: ['boy'],                     level: 5 },
  { id: 'word:night',  display: 'night',  accepted: ['night','nite'],          level: 5 },
  { id: 'word:light',  display: 'light',  accepted: ['light'],                   level: 5 },
  { id: 'word:right',  display: 'right',  accepted: ['right','write'],           level: 5 },
  { id: 'word:high',   display: 'high',   accepted: ['high'],                    level: 5 },
  { id: 'word:read',   display: 'read',   accepted: ['read','red'],              level: 5 },
  { id: 'word:tea',    display: 'tea',    accepted: ['tea'],                     level: 5 },
  { id: 'word:beat',   display: 'beat',   accepted: ['beat'],                    level: 5 },
  { id: 'word:hair',   display: 'hair',   accepted: ['hair'],                    level: 5 },
  { id: 'word:bear',   display: 'bear',   accepted: ['bear'],                    level: 5 },
  { id: 'word:pear',   display: 'pear',   accepted: ['pear'],                    level: 5 },
  { id: 'word:is',     display: 'is',     accepted: ['is'],                      level: 5 },
  { id: 'word:in',     display: 'in',     accepted: ['in'],                      level: 5 },
  { id: 'word:to',     display: 'to',     accepted: ['to'],                      level: 5 },
  { id: 'word:go',     display: 'go',     accepted: ['go'],                      level: 5 },
  { id: 'word:was',    display: 'was',    accepted: ['was'],                     level: 5 },
